...
local data = {
    ...
    { [N] = true, {[N] = true} },             "[[]]",
    { [N] = true, {[N] = true, "a"} },          "[[\"a\"]]",
	 fromhex(gsub('01                        ', ' ', '')), "fixext 1",
    fromhex(gsub('02 01                     ', ' ', '')), "fixext 2",
    fromhex(gsub('04 03 02 01               ', ' ', '')), "fixext 4",
    fromhex(gsub('08 07 06 05 04 03 02 01   ', ' ', '')), "fixext 8",
    fromhex(gsub('10 0f 0e 0d 0c 0b 0a 09 08 07 06 05 04 03 02 01', ' ', '')), "fixext 16",
    fromhex(gsub('61', ' ', '')), "ext 8",
    fromhex(gsub('61', ' ', '')), "ext 16",
    fromhex(gsub('61', ' ', '')), "ext 32",
